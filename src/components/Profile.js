    ...
    async onButtonPress(){
        ...
        if (this.state.password==='') {
            ...
            alert('You must enter Phone Number.')
                ...
                fetch(`http://192.168.10.2/Paramedic/api/EditCallerProfile?id=${userID.cId}`, {
                    method: 'PUT',
                    headers: {
    ...
    render() {
        ...
        return (
            ...
            <TouchableOpacity onPress={()=> this.pickImage()}>
                <Image source={(this.state.image === null) ? require('../assets/user.png') : {uri: 'data:image/jpeg;base64,' + this.state.image}} style={{
