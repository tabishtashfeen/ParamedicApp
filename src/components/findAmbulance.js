...
import { View, Text, StyleSheet, StatusBar, Dimensions, Image, TouchableOpacity, ActivityIndicator, Vibration } from 'react-native';
...
export default class findAmbulance extends Component {
